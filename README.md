...
A project done for module CS4642 - Data Mining &amp; Information Retrieval   asfr
...
1. Searching songs using the Title, Lyric, Artist, Genre, Composer, Movie, Beat, Key, and Musicaa.
